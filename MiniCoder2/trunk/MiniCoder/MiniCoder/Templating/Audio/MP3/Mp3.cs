...
{
    public partial class Mp3 : Form, TemplateForm<Mp3Template>
    {
        private Mp3TemplateController controller;
        private Mp3Template template;

        public Mp3()
        {
            InitializeComponent();
            this.template = new Mp3Template("Default");
            this.controller = new Mp3TemplateController(this, template);
        }

        private void Aac_Load(object sender, EventArgs e)
        {
            ResetInterface();
            UpdateTemplateList(controller.FetchTemplateNames(typeof(Mp3Template)));
        }
        ...
        {
            this.template = (Mp3Template)template;
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            controller.SaveTemplate(name, typeof(Mp3Template));
            UpdateTemplateList(controller.FetchTemplateNames(typeof(Mp3Template)));
        }
        ...
        private void templateItemMenuItem_Click(object sender, EventArgs e)
        {
            ...
            controller.LoadTemplate(name, typeof(Mp3Template));
        }
        ...
        private void mnuDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                if (controller.DeleteTemplate(this.template.Name, typeof(Mp3Template)))
                {
        ...
        private void mnuExport_Click(object sender, EventArgs e)
        {
            ...
            {
                if (controller.ExportTemplate(searchFolderDialog.SelectedPath, typeof(Mp3Template)))
        ...
        private void mnuImport_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                if (!template.Equals(null))
                {
                    ...
                    UpdateData((Mp3Template)template);
                    UpdateTemplateList(controller.FetchTemplateNames(typeof(Mp3Template)));
                }
            }
