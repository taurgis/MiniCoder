...
namespace MiniCoder2.Templating.Audio.AC3
{
    public class Ac3TemplateController
    {
        ...
        {
            this.template = (Ac3Template)templateDao.LoadTemplate(name, typeof(Ac3Template));
        ...
        {
            return templateDao.GetTemplatesByType(typeof(Ac3Template));
        }
        ...
        {
            return templateDao.DeleteTemplate(template.Name, typeof(Ac3Template));
        }
        ...
        {
            return templateDao.ExportTemplate(this.template, typeof(Ac3Template), path + "\\");
        }
        ...
        {
            return templateDao.ImportTemplate(path, typeof(Ac3Template));
        }
    }
}
