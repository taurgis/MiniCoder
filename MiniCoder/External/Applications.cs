...
namespace MiniTech.MiniCoder.External
{
    public class Applications
    {
        ...
        private SortedList<String, ExtApplication> tools = new SortedList<String, ExtApplication>();
        ...
        private void fillPackages()
        {
            ...
            SortedList<String, ExtApplication> defaultPackages = new SortedList<string, ExtApplication>();
        ...
        public void SavePackages()
        {
            ...
            foreach (string key in tools.Keys)
            {
                ExtApplication tempTool = tools[key];
