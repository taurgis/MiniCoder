...
namespace x264_GUI_CS
{
    class Packages
    {
        ...
        private Package newPackage(string appName, string appType, Boolean isRegistry, string registrySubPath,string registrySubKey, string downloadurl)
        {
             Package tempPackage;
             return tempPackage = new Package(appName, appType, isRegistry, registrySubPath, appSettings, registrySubKey, downloadurl);
        }
